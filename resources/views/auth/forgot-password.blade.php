...
<head>
    ...
    <title>Forgot Password | MedixAR</title>
            ...
            <div class="glass-panel w-full h-full rounded-3xl flex flex-col lg:flex-row overflow-hidden shadow-2xl">
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-gray-300 text-lg leading-relaxed max-w-xl">
                            Lost access? No problem. Enter the email address associated with your MedixAR account and we'll send you a secure link to reset your password.
                        </p>
                    </div>
